...
class Context_Guided_Network(BaseModel_backbone_with_neck):
    """
    This class defines the proposed Context Guided Network (CGNet) in this work.
    """
    def __init__(self, M= 3, N= 21, **kwargs):
        """
        args:
    ...
    def forward(self, input):
        ...
        # out = F.upsample(output2_cat, input.size()[2:], mode='bilinear',align_corners = False)   #Upsample score map, factor=8
        # return out
