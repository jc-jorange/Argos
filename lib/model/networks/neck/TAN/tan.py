...
from lib.model.networks.module.conv import ConvModule
from lib.model.networks.module.init_weights import normal_init
from lib.model.networks.module.transformer import TransformerBlock
from .. import BaseModel_neck


class TAN(BaseModel_neck):
    """
