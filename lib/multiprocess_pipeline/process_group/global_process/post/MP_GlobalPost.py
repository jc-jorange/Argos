...
from lib.multiprocess_pipeline.process_group.individual_process import E_Indi_Process_Producer
from lib.multiprocess_pipeline.process_group.global_process import E_Global_Process_Consumer
