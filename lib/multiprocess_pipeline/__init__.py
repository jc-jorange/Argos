...
from lib.multiprocess_pipeline.SharedMemory import DataHub, ConsumerOutputPort
...
class ConsumerProcess(BaseProcess):
    ...
    def __init__(self,
        ...
        self.output_port = ConsumerOutputPort(self.opt, self.output_type, self.data_shape)
