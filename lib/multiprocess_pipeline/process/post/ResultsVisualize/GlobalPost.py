...
from lib.multiprocess_pipeline.process.producer import E_Process_Producer
from lib.multiprocess_pipeline.workers.postprocess import BasePost
from lib.multiprocess_pipeline.workers.postprocess.result_writer import ImageResultWriter, VideoResultWriter
import lib.multiprocess_pipeline.workers.postprocess.utils.write_result as wr


class GloResultsVisualizeProcess(ResultsVisualizeProcess_Master):
